...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference("Currency.count") do
      post currencies_url, params: { currency: { latest_exchange_rate: @currency.latest_exchange_rate, symbol: @currency.symbol } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { latest_exchange_rate: @currency.latest_exchange_rate, symbol: @currency.symbol } }
